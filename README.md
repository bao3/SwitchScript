...
- Download the latest:
  ...
  - `SigPatches` [From Here](https://github.com/impeeza/sys-patch/releases/latest)
...
- all files placed in the current directory `./NS SD Card/`
